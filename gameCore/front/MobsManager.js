...
class MobsManager {
	...
	C_CleanAllMobsDatas() {
		...
		this._mobsIndexToDelete = [];
		if (this._FrontboardManager.FrontMobsCounter) this._FrontboardManager.updateCounter('FrontMobsCounter',this._AllMobs.length);
	...
	addOne(nickname = false, mobType = "mobs") {
		...
		if (this._FrontboardManager.FrontMobsCounter)
			this._FrontboardManager.updateMobUpdateXpCounterthis._AllMobs.length);
